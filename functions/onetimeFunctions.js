                            ...
                            <tr>
                              <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Cabin',sans-serif;" align="left">
                                ...
                                <div style="line-height: 160%; text-align: center; word-wrap: break-word;">
                                  <p style="font-size: 14px; line-height: 160%;"><span style="font-size: 18px; line-height: 28.8px;">Dobrý den, všimli jsme si, že jste dokončili registraci do platformy Roomie, avšak váš e-mail zůstal neověřený. Bez ověření vás nikdo nemůže vidět a vy nemůžete posílat žádosti. Nezoufejte a ověřte svůj e-mail kliknutím na tlačítko níže.</span></p>
                                </div>
      ...
      return Promise.all(
        tokens.docs.map((token) => {
          return db.collection("newUserMail").add({
            message: {
              subject: "Nezapomeňte si ověřit svůj e-mail!",
