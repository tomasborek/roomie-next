...
const ListingHeader = () => {
  ...
  const handleLike = () => {
    if (!currentUser) {
      snackBar(
        "Pro přidání inzerátů do oblíbených se nejdříve přihlašte.",
        "error"
      );
      return;
    }
            ...
            <div className="header-info">
              <div className="info-main">
                <h1 className="main-name">
                  {listingUsername}{" "}
                  {listingPremium && <i className="fas fa-circle-check"></i>}
                </h1>
                {currentUser &&
                  listingInfo &&
                  currentUser.uid == listingInfo.userInfo.uid &&
                  listingInfo.visible &&
                  !cr && (
                    <button
                    ...
                    >
                      {editListing ? "Zpět" : "Upravit inzerát"}
                    </button>
                  )}
                <div className="main-actions">
                  ...
                  {listingInfo &&
                    currentUser &&
                    listingInfo.userInfo.uid != currentUser.uid && (
                      <i
                        onClick={() =>
                          setMoreInfoOpen((prevState) => !prevState)
                        }
                      ...
                      <div className="info-contact">
                        ...
                        <div className="contact-state">
                          ...
                          <p className="state-description">
                            Vaše kontaktní údaje jsou uzamčené.
                          </p>
                        </div>
                      </div>
                      <div className="listing-contact-notice">
                        <p>
                          <i className="fas fa-info-circle"></i> Pro úpravu
                          kontaktních údajů navštivte po dokončení sekci Účet a
                          soukromí.
                        </p>
                      </div>
                    </>
                ...
                <div className="info-main">
                  ...
                  {currentUser &&
                    ...
                    listingInfo.visible && (
                      <button
                        onClick={() =>
                          setEditListing((prevState) => !prevState)
                        }
                        className="main-edit-profile"
                      >
                        {editListing ? "Zpět" : "Upravit inzerát"}
