          ...
          <div className="listing-content">
                  ...
                  <div className="body-messages">
                      ...
                      <div className="messages-message">
                        ...
                        <div className="message-text">
                          <p className="text-main">
                            Váš účet není ověřený - pro používání Roomie si jej
                            prosím ověřte pomocí odkazu zaslaného na váš e-mail.
                          </p>
                    ...
                    {listingInfo && listingInfo.hiddenByUser && (
                      <div className="messages-message">
                        <i className="fas fa-info-circle"></i>
                        <p>
                          Váš účet je skrytý - aby ho mohli uživatelé vidět,
                          zapněte jeho viditelnost v{" "}
                          <Link href="/edit-profile">nastavení profilu</Link>.
                        </p>
                      </div>
                    )}
                  </div>
            ...
            {editListing && (
              <div className="content-edit-buttons">
                {cr && (
                  <p>
                    <i className="fas fa-info-circle"></i> Nezapomeňte na
                    ověření svého e-mailu
                  </p>
                )}
                <button onClick={() => handleSave()} className="main-btn">
                  Uložit změny
                </button>
              </div>
            )}
