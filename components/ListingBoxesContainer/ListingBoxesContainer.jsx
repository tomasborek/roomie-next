        ...
        <div className="profile-boxes-container">
            ...
            <div className="container-content">    
                ...
                <>
                    ...
                    {addedBoxes.smoking && addedBoxes.smoking  != "" && <ListingBox icon="fa-smoking" title="Mazlíček">{addedBoxes.smoking}</ListingBox>}
                    {addedBoxes.job && addedBoxes.job  != "" && <ListingBox icon="fa-graduation-cap" title="Mazlíček">{addedBoxes.job}</ListingBox>}
                    {addedBoxes.children && addedBoxes.children != "" && <ListingBox icon="fa-baby-carriage" title="Mazlíček">{addedBoxes.children}</ListingBox>}
                </>
                }
            </div>
        </div>
