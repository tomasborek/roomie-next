  ...
  return (
    <div onClick={(e) => e.stopPropagation()} className="filter">
      ...
      <div className="filter-description">
        ...
        {variant === "flatmate"
          ? " ideálního spolubydlícího."
          : " ideálního bydlení."}{" "}
        Zaklikejte hodnoty, podle kterých chcete filtrovat, ostatní můžete
        nechat prázdné.
      </div>
      {variant === "flatmate" && (
        <>
          ...
          <section className="filter-section">
            ...
            <div className="section-tags">
              ...
              <Tag
                active={genderTag.includes("Jiné")}
                onClick={() => {
                  let value = "Jiné";
          ...
          <section className="filter-section">
            ...
            <div className="section-tags">
              <Tag
                active={smokingTag === "Kuřák"}
                onClick={() =>
                  setSmokingTag(smokingTag === "Kuřák" ? "" : "Kuřák")
                }
              >
                Kuřák
              </Tag>
              <Tag
                active={smokingTag === "Nekuřák"}
                onClick={() =>
                  setSmokingTag(smokingTag === "Nekuřák" ? "" : "Nekuřák")
                }
              >
                Nekuřák
              </Tag>
          ...
          <section className="filter-section">
            ...
            <div className="section-tags">
              <Tag
                active={jobTag.includes("Zaměstnaný")}
                onClick={() => {
              ...
              <Tag
                active={jobTag.includes("Nezaměstnaný")}
                onClick={() => {
      ...
      {variant === "flat" && (
        <>
          ...
          <section className="filter-section">
            ...
            <div className="section-tags">
              <Tag
                active={elevatorTag === "Výtah"}
                onClick={() =>
                  setElevatorTag(elevatorTag === "Výtah" ? "" : "Výtah")
                }
                variant="box"
              ...
              <Tag
                active={elevatorTag === "Bez výtahu"}
                onClick={() =>
                  setElevatorTag(
                    elevatorTag === "Bez výtahu" ? "" : "Bez výtahu"
                  )
                }
                variant="box"
                icon="caret-square-up"
          ...
          <section className="filter-section">
            ...
            <div className="section-tags">
              <Tag
                active={petAllowedTag === "Mazlíčci povoleno"}
                onClick={() =>
                  setPetAllowedTag(
                    petAllowedTag === "Mazlíčci povoleno"
                      ? ""
                      : "Mazlíčci povoleno"
                  )
                }
              ...
              <Tag
                active={petAllowedTag === "Mazlíčci nepovoleno"}
                onClick={() =>
                  setPetAllowedTag(
                    petAllowedTag === "Mazlíčci nepovoleno"
                      ? ""
                      : "Mazlíčci nepovoleno"
                  )
                }
          ...
          <section className="filter-section">
            ...
            <div className="section-tags">
              <Tag
                active={smokingAllowedTag === "Kouření povoleno"}
                onClick={() =>
                  setSmokingAllowedTag(
                    smokingAllowedTag === "Kouření povoleno"
                      ? ""
                      : "Kouření povoleno"
                  )
                }
              ...
              <Tag
                active={smokingAllowedTag === "Kouření nepovoleno"}
                onClick={() =>
                  setSmokingAllowedTag(
                    smokingAllowedTag === "Kouření nepovoleno"
                      ? ""
                      : "Kouření nepovoleno"
                  )
                }
