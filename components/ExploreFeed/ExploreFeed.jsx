    ...
    <>
      ...
      >
        <div className="dialog-body">
          Pro pokračování a zobrazení dalších inzerátů je nutné se zaregistrovat
          nebo přihlásit do účtu Roomie.
        </div>
      ...
      >
        <div className="dialog-body">
          Pro pokračování a zobrazení dalších inzerátů je nutné mí premium účet
          Roomie.
        </div>
        <div className="dialog-action">
                ...
                {flatmateListings && flatmateListings.length ? (
                  ...
                  <div className="feed-not-found">
                    ...
                    <div className="not-found-description">
                      Omlouváme se, ale vaším požadavkům neodpovídají žádné
                      inzeráty. Zkuste upravit své filtry.
                    </div>
                  </div>
                )}
              </>
