    ...
    return (
      <div className="gallery flatmate">
        <Backdrop
          ...
          open={viewOpen}
        >
          <BackdropTimes onClose={() => setViewOpen(false)} />
          ...
          {editListing && (
            <div className={`container-edit-icon`}>
              ...
              {addedListingImgs[0] ? (
                ...
                <i
                  onClick={() =>
                    handleDelete("normalListingImg", listingImgs[0], 0)
                  }
                  className="fas fa-trash container-delete"
                ></i>
              ) : (
          ...
          {editListing && (
            <div className={`container-edit-icon`}>
              ...
              {addedListingImgs[1] ? (
                ...
                <i
                  onClick={() =>
                    handleDelete("normalListingImg", listingImgs[1], 1)
                  }
                  className="fas fa-trash container-delete"
                ></i>
              ) : (
          ...
          {editListing && (
            <div className={`container-edit-icon`}>
              ...
              {addedListingImgs[2] ? (
                ...
                <i
                  onClick={() =>
                    handleDelete("normalListingImg", listingImgs[2], 2)
                  }
                  className="fas fa-trash container-delete"
                ></i>
              ) : (
          ...
          {editListing && (
            <div className={`container-edit-icon`}>
              ...
              {addedListingImgs[3] ? (
                ...
                <i
                  onClick={() =>
                    handleDelete("normalListingImg", listingImgs[3], 3)
                  }
                  className="fas fa-trash container-delete"
                ></i>
              ) : (
          ...
          {editListing && (
            <div className={`container-edit-icon`}>
              ...
              {addedListingImgs[4] ? (
                ...
                <i
                  onClick={() =>
                    handleDelete("normalListingImg", listingImgs[4], 4)
                  }
                  className="fas fa-trash container-delete"
                ></i>
              ) : (
          ...
          {editListing && (
            <div className={`container-edit-icon`}>
              ...
              {addedListingImgs[5] ? (
                ...
                <i
                  onClick={() =>
                    handleDelete("normalListingImg", listingImgs[5], 5)
                  }
                  className="fas fa-trash container-delete"
                ></i>
              ) : (
