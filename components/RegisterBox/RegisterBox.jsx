...
const RegisterBox = () => {
  ...
  const checkIfFilled = (age) => {
    ...
    if (!termsAgreementRef.current.checked) {
      setError(
        "Pro pokračování prosím zaškrtněte souhlas s obchodními podmínkami."
      );
      return false;
    }
    ...
    <div className="register-box">
      ...
      {step === 3 && type === "flatmate" && (
        <div className="box-content">
          ...
          <h1 className="content-title">
            Jaký je váš maximální měsíční rozpočet na bydlení?
          </h1>
      ...
      {step === 3 && type === "offerer" && (
        <div className="box-content">
          ...
          <h1 className="content-title">
            Kolik činní měsíční nájem pro případné zájemce?
          </h1>
          <RangeStep price={price} setPrice={setPrice} />
          <button
            disabled={!price || price < 1000 || price > 60000}
